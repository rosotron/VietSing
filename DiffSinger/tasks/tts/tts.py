...
class TtsTask(BaseTask):
    def __init__(self, *args, **kwargs):
        self.vocoder = None
        self.phone_encoder = self.build_phone_encoder(hparams['binary_data_dir']) # 'data/binary/viet-pmf0' in usr/viet_fs2.yaml
    ...
    def test_start(self):
        ...
        if hparams.get('pe_enable') is not None and hparams['pe_enable']:
            self.pe = PitchExtractor().cuda() if torch.cuda.is_available() else PitchExtractor()
