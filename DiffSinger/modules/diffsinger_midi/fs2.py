...
class FastspeechMIDIEncoder(FastspeechEncoder):
    def forward_embedding(self, txt_tokens, midi_embedding, midi_dur_embedding, slur_embedding):
        # len of phn, midi, mid_dur, slur need to be the same
        # embed tokens and positions
        # print(txt_tokens)
        # print(self.embed_tokens(txt_tokens).size())
        x = self.embed_scale * self.embed_tokens(txt_tokens)
        # print(x.size())
        # print(midi_embedding.size())
        # print(midi_dur_embedding.size())
        # print(slur_embedding.size())
